...
import demoData from './worldCup2018DemoData.json';
  ...
  render() {
    return (
      <GGEditor className={styles.editor}>
        ...
        <ContextMenu>
          <Card>
            <Command name="undo"><Button type="default">撤销</Button></Command>
            <Command name="redo"><Button type="default">重做</Button></Command>
          </Card>
        </ContextMenu>
      </GGEditor>
    );
