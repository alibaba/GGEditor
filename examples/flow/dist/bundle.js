	...
	class Index extends React.Component {
	    render() {
	        return (React.createElement(GGEditor, { className: styles.editor },
	            React.createElement(lib_5, { className: styles.editorBd, data: data, graphConfig: { defaultNode: { shape: 'customFlowNode' } } }),
	            React.createElement(lib_15, { name: "customFlowNode", extend: "bizTreeNode", config: nodeShapeConfig })));
	    }
	}
