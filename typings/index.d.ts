declare module 'gg-editor' {
  ...
  export const Flow: React.ComponentClass<
    FlowProps & GraphMouseReactEventsProps & GraphOtherReactEventsProps & PageReactEventsProps,
    any
  >;

  /** 思维导图  @see http://ggeditor.com/docs/api/mind.zh-CN.html */
  export const Mind: React.ComponentClass<
    MindProps & GraphMouseReactEventsProps & GraphOtherReactEventsProps & PageReactEventsProps,
    any
  >;

  /** 脑图 */
  export const Koni: React.ComponentClass<
    KoniProps & GraphMouseReactEventsProps & GraphOtherReactEventsProps & PageReactEventsProps,
    any
  >;
  ...
  export const KoniCustomNode: React.ComponentClass<
    ReactProps & GraphMouseReactEventsProps & GraphOtherReactEventsProps & PageReactEventsProps,
    any
  >;
